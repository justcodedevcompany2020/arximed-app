...
import {getSelectTimeNew} from '../../../store/actions/actionsDestination';

export default function PrescriptionDropDownSecond({
  Svg,
  value,
  onChange,
  type,
  ...
  console.log(selectedItems, 'kkkkdfthaerhfdadae');
      ...
      {openDropDown &&
        items.map((item, i) => {
          const toggleSelect = () => {
            ...
            console.log(filtered, 'hdyg');
            dispatch(getSelectTimeNew(filtered));
          };
          return (
            <TouchableOpacity
              style={[
              ...
              onPress={() => {
                ...
                dispatch(getSelectTimeNew(selectedItems));
              }}
              key={i}>
              <Text style={styles.genderText}>
